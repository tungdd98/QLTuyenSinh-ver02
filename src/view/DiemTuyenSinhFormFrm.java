...
public class DiemTuyenSinhFormFrm extends javax.swing.JDialog {
    ...
    public void setListTenNganhThi() {
        ...
        for (int i = 0; i < size; i++) {
            listTenNganhThi[i] = listNganhThi.get(i).getTenNganh() + " - " + listNganhThi.get(i).getMaNganh();
//           
        }
        cb = new JComboBox(listTenNganhThi);
        cb.setBounds(143, 100, 230, 35);
        cb.setName("cbNganhThi");
        this.add(cb);
    }
    ...
    public void getSelectedItem(boolean edit, DiemTuyenSinh item) {
        ...
        cb.setSelectedIndex(indexNganhThi);
        cb.setEnabled(false);
    ...
    private void initComponents() {
        ...
        lbHoTen1.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
        lbHoTen1.setText("Chỉ tiêu");

        lbHoTen2.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
        lbHoTen2.setText("Năm thi");

        lbMaThiSinh1.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(lbMaThiSinh1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String namThi = txtNamThi.getText();
        String code = (String) cb.getSelectedItem();
        String[] str = code.split("\\s\\-\\s");
        maNganh = str[1]; 

        if (!txtDiemChuan.getText().equals("")) {
            diemChuan = Float.parseFloat(txtDiemChuan.getText());
        } else {
            JOptionPane.showMessageDialog(this, "Điểm chuẩn không được để trống");
            isOk = false;
        }

        if (!txtChiTieu.getText().equals("")) {
            chiTieu = Integer.parseInt(txtChiTieu.getText());
        } else {
            JOptionPane.showMessageDialog(this, "Chỉ tiêu không được để trống");
            isOk = false;
        }
        if (isOk) {
            DiemTuyenSinh item = new DiemTuyenSinh(maNganh, diemChuan, chiTieu, namThi);
            if (!isEdit) {
                home.addItem(item);
